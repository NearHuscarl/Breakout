...
namespace Breakout.Core.Models.Blocks
{
	...
	public static class BlockInfo
	{
		...
		{
			{ BlockType.Red,     new BlockAtrributes(health: 40, color: GameColor.Red, favoredPowerUp: PowerUpType.Stronger) },
			{ BlockType.Orange,  new BlockAtrributes(health: 35, color: GameColor.Orange, favoredPowerUp: PowerUpType.Slower) },
			{ BlockType.Yellow,  new BlockAtrributes(health: 30, color: GameColor.Yellow, favoredPowerUp: PowerUpType.Faster) },
			{ BlockType.Green,   new BlockAtrributes(health: 25, color: GameColor.Green, favoredPowerUp: PowerUpType.Double, secondaryFavoredPowerUp: PowerUpType.Triple) },
			{ BlockType.Blue,    new BlockAtrributes(health: 20, color: GameColor.Blue, favoredPowerUp: PowerUpType.Weaker) },
			{ BlockType.Cyan,    new BlockAtrributes(health: 15, color: GameColor.Cyan, favoredPowerUp: PowerUpType.Bigger, secondaryFavoredPowerUp: PowerUpType.Smaller) },
			{ BlockType.Magenta, new BlockAtrributes(health: 10, color: GameColor.Magenta, favoredPowerUp: PowerUpType.Nothing) },
			{ BlockType.Black,   new BlockAtrributes(health: 50, color: GameColor.Black, favoredPowerUp: PowerUpType.Longer, secondaryFavoredPowerUp: PowerUpType.Shorter) },
			{ BlockType.Gray,    new BlockAtrributes(health: 30, color: GameColor.Gray, favoredPowerUp: PowerUpType.Magnetize) },
			{ BlockType.White,   new BlockAtrributes(health: 10, color: GameColor.White, favoredPowerUp: PowerUpType.Nothing) },

			{ BlockType.LightRed,     new BlockAtrributes(health: 10, color: GameColor.Red, favoredPowerUp: PowerUpType.Stronger) },
			{ BlockType.LightOrange,  new BlockAtrributes(health: 10, color: GameColor.Orange, favoredPowerUp: PowerUpType.Slower) },
			{ BlockType.LightYellow,  new BlockAtrributes(health: 10, color: GameColor.Yellow, favoredPowerUp: PowerUpType.Faster) },
			{ BlockType.LightGreen,   new BlockAtrributes(health: 10, color: GameColor.Green, favoredPowerUp: PowerUpType.Double, secondaryFavoredPowerUp: PowerUpType.Triple) },
			{ BlockType.LightBlue,    new BlockAtrributes(health: 10, color: GameColor.Blue, favoredPowerUp: PowerUpType.Weaker) },
			{ BlockType.LightCyan,    new BlockAtrributes(health: 10, color: GameColor.Cyan, favoredPowerUp: PowerUpType.Bigger, secondaryFavoredPowerUp: PowerUpType.Smaller) },
			{ BlockType.LightMagenta, new BlockAtrributes(health: 10, color: GameColor.Magenta, favoredPowerUp: PowerUpType.Nothing) },
			{ BlockType.Dark,         new BlockAtrributes(health: 10, color: GameColor.Black, favoredPowerUp: PowerUpType.Longer, secondaryFavoredPowerUp: PowerUpType.Shorter) },
			{ BlockType.LightGray,    new BlockAtrributes(health: 10, color: GameColor.Gray, favoredPowerUp: PowerUpType.Magnetize) },
			{ BlockType.Silver,       new BlockAtrributes(health: 10, color: GameColor.White, favoredPowerUp: PowerUpType.Nothing) },
